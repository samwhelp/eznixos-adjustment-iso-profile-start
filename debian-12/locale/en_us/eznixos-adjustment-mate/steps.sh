...
mod_overlay_package_list () {
	...
	util_error_echo
	util_error_echo "cp -rf ${THE_PLAN_PACKAGE_DIR_PATH}/mate/. ${THE_PLAN_PROFILE_PACKAGES_DIR_PATH}"
	cp -rf "${THE_PLAN_PACKAGE_DIR_PATH}/mate/." "${THE_PLAN_PROFILE_PACKAGES_DIR_PATH}"
